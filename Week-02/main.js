document.addEventListener("DOMContentLoaded", () => {
    ...
    function displayBooks(bookArray) {
        const limitedBooks = bookArray.slice(0, 10);
    ...
    function displayBooks(bookArray) {
        ...
        if (bookArray.length === 0) {
            bookList.innerHTML = "<p class='NoBooks'>No books found</p>";
            return;
        }
    ...
    function showBookDetails(book) {
        ...
        document.getElementById("popup-isbn").textContent = book.isbn;
        document.getElementById("popup-pages").textContent = book.pageCount;
        document.getElementById("popup-image").src = book.thumbnailUrl;

        let words = book.longDescription.split(" ");
        let shortDescription = words.slice(0, 100).join(" ");
        if (words.length > 100) shortDescription += "...";

        document.getElementById("popup-description").textContent = shortDescription;
